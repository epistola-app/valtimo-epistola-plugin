...
- **The frontend package manifest now leaves Angular entry-point generation to ng-packagr.** Redundant source `module`, `typings`, and `exports` fields were removed; the built package still receives the generated ESM and type exports without ng-packagr override warnings.
