  ...
  pluginTranslations: {
    nl: {
      ...
      variantAttributesTooltip:
        'Kenmerken voor automatische variantselectie. Waarden zijn JSONata-expressies; zet letterlijke tekst tussen dubbele aanhalingstekens.',
      attributeKey: 'Kenmerk',
      attributeKeyCustom: 'Aangepast...',
      attributeValue: 'Waarde',
      attributeValueExpressionPlaceholder: '"nl" of $pv.language',
      ...
      expressionEditorSwitchAdvanced: 'Naar geavanceerde editor',
      expressionEditorSwitchVisual: 'Naar visuele editor',
      ...
      expressionEditorJsonataVariable: 'JSONata-variabele',
    ...
    en: {
      ...
      variantAttributesTooltip:
        'Attributes for automatic variant selection. Values are JSONata expressions; wrap literal text in double quotes.',
      attributeKey: 'Attribute',
      attributeKeyCustom: 'Custom...',
      attributeValue: 'Value',
      attributeValueExpressionPlaceholder: '"nl" or $pv.language',
      ...
      expressionEditorSwitchAdvanced: 'Switch to Advanced editor',
      expressionEditorSwitchVisual: 'Switch to Visual editor',
      ...
      expressionEditorJsonataVariable: 'JSONata variable',
