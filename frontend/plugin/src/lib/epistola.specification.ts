...
const epistolaPluginSpecification: PluginSpecification = {
  ...
  pluginTranslations: {
    nl: {
      ...
      defaultEnvironmentIdTooltip: 'De standaard omgeving voor documentgeneratie (optioneel)',
    ...
    en: {
      ...
      defaultEnvironmentIdTooltip: 'The default environment for document generation (optional)',
